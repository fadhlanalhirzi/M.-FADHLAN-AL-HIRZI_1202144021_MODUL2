...
public class mnAdapter extends RecyclerView.Adapter<mnAdapter.menuholder> {
    ...
    private List<pilihmakanan> listmenu;


    public mnAdapter(Context context, List<pilihmakanan> listmenu) {
    ...
    public menuholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.menu1, parent, false);
    ...
    public void onBindViewHolder(menuholder holder, int position) {
        pilihmakanan data = listmenu.get(position);
